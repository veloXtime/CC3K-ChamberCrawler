...
% font setting
%\usepackage[10pt]{moresize} \usepackage[utf8]{inputenc}
...
%For example, orcs do 50\% more damage to goblins. This is where template method
%is applied. In the Goblin class, its function
